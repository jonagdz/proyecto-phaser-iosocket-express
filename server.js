...
var carguero6 = {}
var carguerosArre = [];
var limiteConexiones = 2; // Establezco el limite de clientes que pueden conectarse
...
io.on('connection', function (socket) {
  if (io.engine.clientsCount > limiteConexiones){
    ...
    socket.emit('currentPlayers', players) // Notifico al nuevo jugador sobre todos los jugadores que ya se encuentran actualmente
    socket.broadcast.emit('newPlayer', players[socket.id]) // Notifico a todos los clientes actuales, que ingreso un nuevo jugador
